...
class RegistrationForm(UserCreationForm):
    ...
    def clean_email(self):  #unıque email yapmak için bu işlemleri uyguladık.
    ...
    # def clean_first_name(self): #burada name içerisinde A varsa error ver diyoruz.Örnek olarak böyle validations yapabiliriz.
